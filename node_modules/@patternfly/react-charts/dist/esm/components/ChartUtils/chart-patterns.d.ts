 ...
 * @private
 */
export declare const getDefaultPatternProps: ({ colorScale, hasPatterns, patternScale, themeColorScale }: PatternPropsInterface) => {
 ...
 * @private
 */
export declare const renderChildrenWithPatterns: ({ children, patternScale }: PatternPropsInterface) => {}[];
export {};
