...
export const ChartCursorTooltip = (_a) => {
    var { constrainToVisibleArea = true, flyoutComponent = React.createElement(ChartCursorFlyout, null), labelComponent = React.createElement(ChartLabel, null), labelTextAnchor = 'start', showPointer = true, style, themeColor, 
