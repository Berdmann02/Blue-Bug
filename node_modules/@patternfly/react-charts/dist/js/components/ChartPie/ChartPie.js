...
const ChartPie = (_a) => {
    ...
    const legend = React.cloneElement(legendComponent, Object.assign({ colorScale, data: legendData, key: 'pf-chart-pie-legend', orientation: legendOrientation, theme }, legendComponent.props));
