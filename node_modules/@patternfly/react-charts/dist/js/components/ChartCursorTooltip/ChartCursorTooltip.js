...
const ChartCursorTooltip = (_a) => {
    var { constrainToVisibleArea = true, flyoutComponent = React.createElement(ChartCursorFlyout_1.ChartCursorFlyout, null), labelComponent = React.createElement(ChartLabel_1.ChartLabel, null), labelTextAnchor = 'start', showPointer = true, style, themeColor, 
