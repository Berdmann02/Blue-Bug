...
const ChartAxis = (_a) => {
    var { containerComponent = React.createElement(ChartContainer_1.ChartContainer, null), showGrid = false, themeColor, 
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    themeVariant, 
    // destructure last
    theme = ChartUtils_1.getTheme(themeColor) } = _a, rest = tslib_1.__rest(_a, ["containerComponent", "showGrid", "themeColor", "themeVariant", "theme"]);
    // Clone so users can override container props
    const container = React.cloneElement(containerComponent, Object.assign({ theme }, containerComponent.props));
    // Note: containerComponent is required for theme
    return React.createElement(victory_axis_1.VictoryAxis, Object.assign({ containerComponent: container, theme: showGrid ? ChartUtils_1.getAxisTheme(themeColor) : theme }, rest));
};
