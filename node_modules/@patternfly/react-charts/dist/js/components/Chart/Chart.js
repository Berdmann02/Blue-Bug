...
const Chart = (_a) => {
    var { ariaDesc, ariaTitle, children, colorScale, hasPatterns, legendAllowWrap = false, legendComponent = React.createElement(ChartLegend_1.ChartLegend, null), legendData, legendPosition = ChartTheme_1.ChartCommonStyles.legend.position, padding, patternScale, showAxis = true, themeColor, 
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    themeVariant, 
    // destructure last
    theme = ChartUtils_1.getChartTheme(themeColor, showAxis), containerComponent = React.createElement(ChartContainer_1.ChartContainer, null), legendOrientation = theme.legend.orientation, height = theme.chart.height, width = theme.chart.width } = _a, rest = tslib_1.__rest(_a, ["ariaDesc", "ariaTitle", "children", "colorScale", "hasPatterns", "legendAllowWrap", "legendComponent", "legendData", "legendPosition", "padding", "patternScale", "showAxis", "themeColor", "themeVariant", "theme", "containerComponent", "legendOrientation", "height", "width"]);
    ...
    const { defaultColorScale, defaultPatternScale, isPatternDefs, patternId } = ChartUtils_1.getDefaultPatternProps({
        colorScale,
        patternScale,
        hasPatterns,
    ...
    const renderChildren = () => React.Children.toArray(children).map(child => {
        if (React.isValidElement(child)) {
            ...
            return React.cloneElement(child, Object.assign(Object.assign(Object.assign({ colorScale,
                theme }, (defaultPatternScale && { patternScale: defaultPatternScale })), childProps), (child.type.displayName === 'ChartPie' && {
