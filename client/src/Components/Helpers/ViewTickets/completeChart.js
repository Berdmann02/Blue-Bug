...
const { completeTickets, user } = useGlobalContext();
      ...
      <Table stickyHeader aria-label="sticky table" >
        <TableHead>
          ...
          <StyledTableCell width={170} align="center" style={{ fontWeight: '500', fontStyle: 'italic' }}>Ticket Name</StyledTableCell>
            ...
            <StyledTableCell width={170} align="center" style={{ fontWeight: '500', fontStyle: 'italic' }}>Severity</StyledTableCell>
        ...
        {completeTickets.filter(ticket => ticket.assign.includes(user._id)).slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((tickets) => (
            ...
            >
              ...
              <TableCell align="center">{tickets.severity}</TableCell>
